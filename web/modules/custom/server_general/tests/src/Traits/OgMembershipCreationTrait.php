...
trait OgMembershipCreationTrait {
   ...
   */
  protected function createOgMembership(EntityInterface $group, AccountInterface $user, ?array $role_names = NULL, ?string $state = NULL, ?string $membership_type = NULL): OgMembershipInterface {
